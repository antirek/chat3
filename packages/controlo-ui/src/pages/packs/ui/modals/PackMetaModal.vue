<template>
  <BaseModal :is-open="isOpen" title="🏷️ Meta теги пака" max-width="600px" @close="close">
    <div class="meta-list">
      ...
      <table v-else>
        ...
        <tbody>
          <tr v-for="(value, key) in metaTags" :key="key">
            ...
            <td>
              <BaseButton variant="danger" size="small" @click="deleteTag(String(key))">🗑️ Удалить</BaseButton>
            </td>
          </tr>
        </tbody>
      </table>
    ...
    <div class="meta-section">
      ...
      <div class="meta-tag-row">
        <input type="text" v-model="localMetaKey" placeholder="key (например: category)" />
        <input type="text" v-model="localMetaValue" placeholder="value (например: support)" />
