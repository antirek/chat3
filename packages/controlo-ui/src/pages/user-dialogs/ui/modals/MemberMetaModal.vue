<template>
  <BaseModal :is-open="isOpen" :title="`🏷️ Мета-теги участника: ${userId}`" max-width="800px" @close="close">
    ...
    <div class="meta-list">
      ...
      <div v-if="metaTags.length === 0" class="no-data">Meta теги отсутствуют</div>
    ...
    <div class="meta-section">
      ...
      <div class="meta-tag-form">
        <div class="form-row">
          ...
          <input type="text" v-model="newKey" placeholder="key (например: role)" class="form-input" />
        </div>
        <div class="form-row form-row-value">
          <div class="value-cell">
            ...
            <div v-else-if="valueType === 'object'" class="object-editor">
              ...
              <BaseButton type="button" variant="secondary" size="small" @click="addObjectPair">➕ Добавить пару</BaseButton>
            </div>
          </div>
          <div class="type-cell">
