<template>
  <div class="filter-form">
    <div class="filter-examples">
      <span class="filter-example" @click="setFilterExample('eventType', 'message.create')">message.create</span>
      <span class="filter-example" @click="setFilterExample('eventType', 'dialog.create')">dialog.create</span>
    </div>
