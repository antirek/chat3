...
export function usePacksPage() {
  ...
  return {
    ...
    toggleSort,
    formatTimestamp,
    createMetaTags: modalsModule.createMetaTags,
    newMetaKeyForCreate: modalsModule.newMetaKeyForCreate,
    newMetaValueForCreate: modalsModule.newMetaValueForCreate,
    createSubmitting: modalsModule.createSubmitting,
    showCreateModal,
    closeCreateModal: modalsModule.closeCreateModal,
    addCreateMetaTag: modalsModule.addCreateMetaTag,
    removeCreateMetaTag: modalsModule.removeCreateMetaTag,
    createPack,
    showAddDialogModal,
    closeAddDialogModal,
    addDialogToPack,
