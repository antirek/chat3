...
const userDialogStatsSchema = new mongoose.Schema({
    tenantId: {
        type: String,
        required: true,
        index: true,
...
const UserDialogStats = mongoose.model('UserDialogStats', userDialogStatsSchema);
export default UserDialogStats;
//# sourceMappingURL=UserDialogStats.js.map