 ...
 */
router.get('/:id/events', apiAuth, requirePermission('read'), validateDialogId, dialogController.getDialogEvents);
 ...
 *         description: Internal Server Error
 */
router.get('/:id/updates', apiAuth, requirePermission('read'), validateDialogId, dialogController.getDialogUpdates);
