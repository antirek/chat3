<template>
  <BaseModal :is-open="isOpen" title="🏷️ Meta теги топика" max-width="800px" @close="close">
    <div class="meta-list">
    ...
    <div class="meta-section">
      ...
      <div class="meta-tag-form">
        <div class="form-row">
          ...
          <input type="text" v-model="newKey" placeholder="key" class="form-input" />
        </div>
        ...
        <div class="form-row form-row-value">
          <div class="value-cell">
            ...
            <input
              ...
              type="text"
              v-model="scalarValue"
              placeholder='value (прим: "internal", ["foo", "bar"], {"foo": "bar"}, 5, false)'
              class="form-input"
            />
