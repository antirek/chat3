...
// TypeScript интерфейс для документа UserDialogActivity
...
const userDialogActivitySchema = new mongoose.Schema<IUserDialogActivity>({
  tenantId: {
    type: String,
    required: true,
    index: true,
...
const UserDialogActivity = mongoose.model<IUserDialogActivity>('UserDialogActivity', userDialogActivitySchema);
