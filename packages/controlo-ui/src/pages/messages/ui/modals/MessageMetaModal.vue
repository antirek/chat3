<template>
  <BaseModal :is-open="isOpen" title="🏷️ Meta теги сообщения" max-width="800px" @close="close">
    <div class="meta-list">
      ...
      <table v-else class="meta-table">
        ...
        <tbody>
          <tr v-for="(value, key) in metaTags" :key="key">
            ...
            <td>
              <BaseButton type="button" variant="danger" size="small" @click="deleteTag(String(key))">🗑️ Удалить</BaseButton>
            </td>
          </tr>
        </tbody>
      </table>
    ...
    <div class="meta-section">
      ...
      <div class="meta-tag-form">
        <div class="form-row">
          ...
          <input type="text" v-model="newKey" placeholder="key (например: channelType)" class="form-input" />
        </div>
