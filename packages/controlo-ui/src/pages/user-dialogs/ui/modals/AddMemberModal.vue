        ...
        <form @submit.prevent="$emit('submit')">
          <div class="form-group">
            ...
            <select
              ...
              :value="selectedUser"
              @change="$emit('update:selectedUser', ($event.target as HTMLSelectElement).value)"
              required
          ...
          <div class="form-group">
            ...
            <select
              ...
              :value="memberType"
              @change="$emit('update:memberType', ($event.target as HTMLSelectElement).value)"
              style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 6px; font-size: 14px;"
            >
...
defineEmits<{
  (e: 'close'): void;
  (e: 'submit'): void;
  (e: 'update:selectedUser', value: string): void;
  (e: 'update:memberType', value: string): void;
  (e: 'add-meta-row'): void;
