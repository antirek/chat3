<template>
  <BaseModal :is-open="isOpen" title="🏷️ Meta теги пользователя" max-width="800px" @close="close">
    <div class="meta-list">
    ...
    <div class="meta-section">
      ...
      <div class="meta-tag-form">
        <div class="form-row">
          ...
          <input type="text" v-model="newKey" placeholder="key (например: department)" class="form-input" />
        </div>
