...
// TypeScript интерфейс для документа DialogStats
...
const dialogStatsSchema = new mongoose.Schema<IDialogStats>({
  tenantId: {
    type: String,
    required: true,
    index: true,
...
const DialogStats = mongoose.model<IDialogStats>('DialogStats', dialogStatsSchema);
