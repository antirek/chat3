...
## 📝 Последние изменения (последние 5 коммитов)

### 77d03a4 (3 ноября 2025) - Система Updates
- Добавлена система Updates для персональных обновлений участников диалогов
- Реализована модель Update с поддержкой DialogUpdate и MessageUpdate
- Интеграция с RabbitMQ для доставки обновлений через персональные очереди пользователей
- Добавлена документация UPDATES.md с примерами использования

### f30b154 (31 октября 2025) - Улучшения и исправления
- Обновления в конфигурации AdminJS
- Улучшения контроллеров сообщений и реакций
- Исправления в утилитах для работы с событиями, RabbitMQ и счетчиками непрочитанных сообщений
- Обновления в seed-скрипте для тестовых данных

### bed7e2c (31 октября 2025) - Исправления UI
- Исправления в тестовом интерфейсе api-test-user-dialogs.html
- Улучшения пользовательского интерфейса для тестирования API

### 4d1f4c5 (31 октября 2025) - Система реакций на сообщения
- Добавлена модель MessageReaction для реакций на сообщения
- Реализованы API endpoints для управления реакциями (добавление, обновление, удаление)
- Обновлены тестовые интерфейсы для работы с реакциями
- Добавлены утилиты для работы с реакциями (reactionUtils)
- Обновлена документация EVENTS.md и README.md

### f835999 (31 октября 2025) - Система событий и RabbitMQ
- Реализована полная система событий (Events) для аудита действий
- Добавлена интеграция с RabbitMQ для публикации событий в реальном времени
- Созданы утилиты для работы с событиями (eventUtils, rabbitmqUtils)
- Добавлены примеры потребителей RabbitMQ в examples/
- Реализованы API endpoints для просмотра событий и статистики
- Обновлена документация EVENTS.md с описанием системы событий
