...
// TypeScript интерфейс для документа MessageReactionStats
...
const messageReactionStatsSchema = new mongoose.Schema<IMessageReactionStats>({
  tenantId: {
    type: String,
    required: true,
    index: true,
...
const MessageReactionStats = mongoose.model<IMessageReactionStats>('MessageReactionStats', messageReactionStatsSchema);
